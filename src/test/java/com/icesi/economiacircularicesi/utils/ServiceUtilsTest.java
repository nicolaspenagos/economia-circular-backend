...
public class ServiceUtilsTest {
    ...
    public void getIndexOfTestWithUsers(){
        ...
        int index = ServiceUtils.getIndexOf(usersList, id);
        assertTrue(index == 0);
        assertTrue(usersList.get(index).getName().equals("Nicolas"));

        assertTrue(ServiceUtils.getIndexOf(usersList, UUID.randomUUID())==-1);
    ...
    public void getIndexOfTestWithQuestions(){
        ...
        int index = ServiceUtils.getIndexOf(questionsList, id);
        assertTrue(index == 2);
        assertTrue(questionsList.get(index).getQuestionText().equals("Txt3"));

        assertTrue(ServiceUtils.getIndexOf(questionsList, UUID.randomUUID())==-1);

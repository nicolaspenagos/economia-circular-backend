...
INSERT INTO "QUESTIONS" (question_id, question_order, question_text,mandatory, justify, type, activity ) VALUES ('1539215e-879a-4d04-aaff-b99ffd770d20', 1, 'First question statement', true,true, 'INCREMENTAL_SINGLE_ANSWER', 'A2');
INSERT INTO "QUESTIONS" (question_id, question_order, question_text,mandatory, justify,type, activity ) VALUES ('200176e0-2600-40e4-87ee-1b832a425caf', 1, 'Second question statement', true,true, 'SINGLE_ANSWER', 'A11');
INSERT INTO "QUESTIONS" (question_id, question_order, question_text,mandatory, justify,type, activity ) VALUES ('8090410a-0f48-462a-a1d3-e002a2a5ca1f', 1, 'Question statement', true,true, 'MULTIPLE_CHOICE', 'A1');
INSERT INTO "QUESTIONS" (question_id, question_order, question_text,mandatory, justify,type, activity ) VALUES ('b9589cbf-d309-447d-8b34-0b4d3a890c1f', 1, 'Question to delete statement', true,true, 'MULTIPLE_CHOICE', 'A1');
INSERT INTO "QUESTIONS" (question_id, question_order, question_text,mandatory, justify,type, activity ) VALUES ('98af9133-409b-41ad-a7f8-3f0f7f3b92f1', 1, 'Last question', true,true, 'MULTIPLE_CHOICE', 'A1');
